...
class PublishCommand extends BaseCommand
{
    ...
    /**
     * The path to agungsugiarto\simba\src directory.
     *
     * @var string
     */
    ...
    {
        $path = "{$this->sourcePath}/Config/Simba.php";

        $content = file_get_contents($path);
        $content = str_replace('namespace simba\api\Config', 'namespace Config', $content);

        $this->writeFile('Config/Simba.php', $content);
    }
    ...
    protected function publishMigration(): void
    {
        ...
        foreach ($map as $file) {
            ...
            $content = str_replace('namespace simba\api\Database\Migrations', 'namespace ' . APP_NAMESPACE . '\Database\Migrations', $content);
